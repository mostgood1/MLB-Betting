...
class UltraFastSimEngine:
    ...
    def _load_team_strengths(self) -> Dict[str, float]:
        """Load team strengths from master data"""
        try:
            ...
            print(f"Warning: Could not load team strengths: {e}")
        
        # Default strength estimates
        return {
    ...
    def _load_pitcher_stats(self) -> Dict[str, Dict]:
        """Load pitcher stats from master data"""
        try:
